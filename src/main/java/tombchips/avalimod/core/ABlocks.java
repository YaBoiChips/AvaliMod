...
import tombchips.avalimod.common.blocks.AmmoniaIceBlock;
...
public class ABlocks {
    ...
    public static final Block FROZEN_STONE = createHardStoneBlock("frozen_stone");
    public static final Block FROZEN_COBBLESTONE = createCobbleBlock("frozen_cobblestone");
    ...
    static @Nonnull Block createHardStoneBlock(String id) {
        Block stone = new Block(AbstractBlock.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(3F, 8.0F));
