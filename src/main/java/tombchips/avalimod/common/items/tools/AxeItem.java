...
public class AxeItem extends ToolItem {
    ...
    public AxeItem(IItemTier iItemTier, float v, float v1, Item.Properties properties) {
        super(v, v1, iItemTier, OTHER_DIGGABLE_BLOCKS, properties.addToolType(net.minecraftforge.common.ToolType.AXE, iItemTier.getLevel()));
    }
        ...
        if (block != null) {
            ...
            if (!world.isClientSide) {
                ...
                if (playerentity != null) {
                    itemUseContext.getItemInHand().hurtAndBreak(1, playerentity, (playerEntity) -> {
