...
public class AvalonFrozenSB extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    public AvalonFrozenSB(Codec<SurfaceBuilderBaseConfiguration> p_i232136_1_) {
        super(p_i232136_1_);
    }
