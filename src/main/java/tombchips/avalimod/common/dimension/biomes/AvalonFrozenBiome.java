...
public class AvalonFrozenBiome extends BiomeBase {
    ...
    static {
        ...
        GENERATION_SETTINGS.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Feature.ICE_SPIKE.configured(IFeatureConfig.NONE).decorated(Features.Placements.HEIGHTMAP_WORLD_SURFACE).count(3));
        GENERATION_SETTINGS.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Feature.ICE_PATCH.configured(new SphereReplaceConfig(Blocks.PACKED_ICE.defaultBlockState(), FeatureSpread.of(2, 1), 1, ImmutableList.of(Blocks.DIRT.defaultBlockState(), Blocks.GRASS_BLOCK.defaultBlockState(), Blocks.PODZOL.defaultBlockState(), Blocks.COARSE_DIRT.defaultBlockState(),Blocks.SNOW_BLOCK.defaultBlockState(), Blocks.ICE.defaultBlockState()))).decorated(Features.Placements.HEIGHTMAP_WORLD_SURFACE).count(1));
